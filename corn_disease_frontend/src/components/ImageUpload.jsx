        ...
        {imagePreview ? (
          ...
          <div className="text-center">
            ...
            <p className="text-gray-700 mb-2">
              Drag & drop a corn leaf image here
            </p>
            <p className="text-gray-500 text-sm">or</p>
            <p className="text-gray-700 mb-2">
              Upload the Image via "Browse Image"
            </p>
          </div>
        )}
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="mb-4 w-full">
          ...
          <select
            ...
            className="bg-white bg-opacity-0 w-full p-2 border border-gray-600 rounded-lg focus:ring-green-600 focus:border-green-600"
          >
            {models.map((model, index) => (
              <option key={index} value={model} className="bg-white-500 bg-opacity-50 text-black">
                {model}
              </option>
            ))}
          </select>
